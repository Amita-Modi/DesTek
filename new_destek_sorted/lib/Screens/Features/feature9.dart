...
class _Feature9State extends State<Feature9> {
  ...
  void initState() {
    super.initState();
    _speak("Today's date is, ${now.day}, ${now.month}, ${now.year}, and, Current time is, ${now.hour} hours, ${now.minute} minutes, and, ${now.second} seconds");
    }
                      ...
                      Center(
                        child: Container(
                          ...
                          margin: EdgeInsets.only(
                              left: 5.0, right: 5.0, top: 5.0, bottom: 30.0),
