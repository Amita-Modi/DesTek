...
import 'package:new_destek_sorted/Screens/NavigationBarScreens/games.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  _voiceCommand(String text) async {
    ...
    } else if (text.toLowerCase() == "play a game" ||
        text.toLowerCase() == "open game" ||
        text.toLowerCase() == "i want to play a game" ||
        ...
        child: SingleChildScrollView(
          ...
          Container(
            ...
            margin: EdgeInsets.only(
                top: 2.0, bottom: 40.0, left: 20.0, right: 20.0),
            decoration: BoxDecoration(
